class ApiUrl {
  ...
  //TV SERIES
  static const String tvSeriesOnAir =
      '$BASE_URL/tv/on_the_air?$API_KEY&$NETWORK';
  ...
  static String tvSeriesRecommendation(int id) =>
      '$BASE_URL/tv/$id/recommendations?$API_KEY&$NETWORK';

  static String searchTvSeries(String query) =>
      '$BASE_URL/search/tv?$API_KEY&query=$query';

  static String tvSeriesSeason(int id, int seasonNumber) =>
      '$BASE_URL/tv/$id/season/$seasonNumber?$API_KEY&$NETWORK';
}
